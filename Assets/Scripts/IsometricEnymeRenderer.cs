...
public class IsometricEnymeRenderer : MonoBehaviour
{

    public static readonly string[] idleDirections = { "BoarIdle_NE", "BoarIdle_NW","BoarIdle_SW", "BoarIdle_SE" };
    public static readonly string[] runDirections = { "BoarRun_NE","BoarRun_NW", "BoarRun_SW", "BoarRun_SE" };
